...
//     // ✅ Filter by patient name or reason (customize as per your schema)
//     const filter = search
//       ? {
//           $or: [
//             { patientName: { $regex: search, $options: "i" } },   // if Record has patient name
...
// // Get record by ID
// const getRecordByById = async (req, res) => {
//   try {
//     const { id } = req.params; // ✅ use route param
//     const record = await Record.findById(id);
